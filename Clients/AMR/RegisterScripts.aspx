            ...
            $(document).ready(function () {
                ...
                findHostWebUrl(document.location.pathname).then(function (url) {
                    ...
                    $("button#autoload-commands").click(function () {
                        ...
                        spg.installUserCustomActionCustom("site", "SiteAssets/PSV/js/PSDataAccessLibrary.js", 1000);
...
<body style="display: none">
    ...
    <div id="MainContent" style="padding-left:20px;">
        ...
        (use relative urls, it will install on current site)
        <br/> This page lists the current user custom actions configured for the current site and site collection.
        <br />
        <br />
        ...
        <div>
            ...
            <li>SiteAssets/PSV/js/PSDataAccessLibrary.js</li>
