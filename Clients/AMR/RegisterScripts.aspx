    ...
    $(document).ready(function () {
        ...
        findHostWebUrl(document.location.pathname).then(function (url) {
            ...
            $("button#autoload-commands").click(function () {
                spg.installUserCustomActionCustom("site","SiteAssets/js/jquery-3.1.1.min.js",1);
                spg.installUserCustomActionCustom("site","SiteAssets/CustomStyle.css",1);
                spg.installUserCustomActionCustom("site","SiteAssets/js/AMRJScript.js",1000);
...
<li>SiteAssets/js/jquery-3.1.1.min.js</li>
<li>SiteAssets/CustomStyle.css</li>
<li>SiteAssets/js/AMRJScript.js</li>
</div>
        <br />
