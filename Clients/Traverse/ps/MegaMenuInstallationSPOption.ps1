...
$targetSiteCollection= Read-Host "Please enter Target Site Collection URL, where you want mega menu and branding to be applied (Example: https://travind.sharepoint.com/teams/Site1)"
if($targetSiteCollection){
    $sourceSiteCollection = "https://travind.sharepoint.com"
    $sourceAssetLibraryTitle = "Site Assets"
    #$targetSiteCollection = "https://travind.sharepoint.com/teams/Site1"
